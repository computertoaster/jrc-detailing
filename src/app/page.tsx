          ...
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
            ...
            <AnimatedSection direction="right">
              ...
              <h2 className="mb-6 font-heading text-4xl font-extrabold md:text-5xl">
                Meet <span className="text-gradient-gold">Jesse Curtain</span>
              </h2>
      ...
      <section className="relative overflow-hidden py-32">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6">
          <AnimatedSection className="text-center lg:text-left">
            ...
            <Link
              href="/contact"
              className="inline-block rounded-sm bg-gold px-8 py-3 font-heading text-xs font-semibold uppercase tracking-[2px] text-black transition-all duration-300 hover:bg-gold-hover hover:shadow-lg hover:shadow-gold/25"
            >
              Request a Quote
            </Link>
          </AnimatedSection>
        ...
        <div className="mx-auto max-w-3xl px-6 text-center">
          <AnimatedSection>
            ...
            <a
              ...
              className="inline-flex items-center gap-3 text-lg text-white/60 transition-colors duration-300 hover:text-gold"
            >
