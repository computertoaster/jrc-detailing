        ...
        <div className="mx-auto max-w-3xl px-6 text-center">
          <AnimatedSection>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 font-heading text-sm font-semibold uppercase tracking-wider text-gold transition-colors duration-300 hover:text-white"
            >
